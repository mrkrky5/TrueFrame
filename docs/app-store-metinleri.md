# App Store Metinleri — True Frame
...
tarih,medya,oyun,film,dizi,gerçek,eğitim,belgesel,antik,samuray,savaş,keşif

## Anahtar kelimeler (EN)

history,media,game,movie,series,facts,education,documentary,ancient,learning,true,frame
...
Muhtemelen **4+** veya içerikteki savaş/tarihsel şiddet temalarına göre **9+** — App Store anketiyle netleştirin.
...
2. Ana sayfa — Bugünün Gerçeklik Kontrolü
3. Keşfet — arama ve dosyalar
4. Medya dosyası (dossier)
5. Derin dosya okuyucu + spoiler kapısı
6. Öğrenme rotası
7. Kitaplık
